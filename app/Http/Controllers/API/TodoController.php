...
class TodoController extends Controller
{
    ...
    #[Response(
        ...
        content: [
            "status_code" => 401,
            "message" => "Token terotentikasi atau Token tidak valid"
        ]
    )]
    ...
    /**
     * Mengambil semua todo milik pengguna yang teautentikasi.
     */
    #[
        Response(
            status: 200,
    ...
    #[
        Response(
            ...
            content: [
                'success' => false,
                'message' => 'Tidak terautoentikasi atau token tidak valid'
            ]
        )
    ]
